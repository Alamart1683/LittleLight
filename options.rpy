...
define config.name = _("LittleLight")
...
define gui.about = _p(""" Данная игра разрабатывается командой LittleLight в рамках
выполнения проекта по дисциплине Системная и Программная Инженерия студентами 
группы ИКБО-12-17 Лисовым Андреем и Каревой Мариной.
""")
...
define config.save_directory = "Game-1551695145"
