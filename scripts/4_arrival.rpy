...
label train_moving:
    if flag == False:
        scene bg black
        u"Онтос" "Вы проспыпаетесь в плацкартном вагоне от невыносимого запаха носков соседа..."
        hide bg black
        scene bg train
        u"Онтос" "Поезд делает ту-ту и чух-чух!"
...
label train_stopping:
    scene bg black
    u"Онтос" "За окном стали заметны силуэты домов, и вы почувствовали, что поезд начал постепенно сбавлять ход..."
    u"Поезд" "Чучух-чучух... Чучух-чучух... Издает скрипение тормозов... Издает их еще..."
    u"Онтос" "Медленно и невозмутимо поезд прибывал на платформу вокзала уездного города N"
    u"Онтос" "Вы берете свои вещи и направляетесь к выходу из вагона, издавая топающие звуки"
    u"Поезд" "Тем временем я остановился и меня немного тряхнуло."
    u"Онтос" "Вы выходите из вагона и оказываетесь на городском вокзале..."
    hide bg black
    call station
...
label station:
    scene bg station
    u"Онтос" "Вы оглядываетесь и видите весьма потрепанное здание городского воказала"
    u"Онтос" "Вы решаете последовать в него с целью узнать где здесь можно остановиться..."
    u"Онтос" "Пока конец"
    $ flag = False
    hide bg station
    call start
